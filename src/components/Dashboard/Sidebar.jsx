import { Briefcase, Calendar, GraduationCap, LayoutDashboard, MessageSquare, Settings, User, Users, X, Sparkles, RollerCoaster, SquareChevronUp, Key, Shield } from "lucide-react";
import { NavLink } from "react-router-dom";

const navItems = [
  { label: "Dashboard", icon: LayoutDashboard, path: "/dashboard" },
  { label: "User", icon: Users, path: "/dashboard/users" },
  { label: "Role", icon: Shield, path: "/dashboard/role" },
  { label: "Permission", icon: Key, path: "/dashboard/permission" },
